...
define("src/Audio/tag/AudioTagController", ["require", "exports", "src/base/Emitter", "src/Audio/Audio"], function (require, exports, Emitter_1, Audio_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /** 音频标签控制器 */
            ...
            return new Promise(function (resolve, reject) {
                ...
                switch (res.state) {
                    ...
                    case EnumLoadState.ERROR:
                        ...
                        Loader_1.Loader.sendHttpRequest({
                            url: url,
                            method: "GET",
                            responseType: "blob",
...
define("test/base/test_Emitter", ["require", "exports", "src/base/Emitter"], function (require, exports, Emitter_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function default_2() {
        return __awaiter(this, void 0, void 0, function () {
